    ...
    for category in categories:
        ...
        for layer in layers:
            layer_path = os.path.join(
                feature_dir, f"{dataset_type}/blocknet_handcrafts_features/{category}/{layer}"
            )
...
def main():
    ...
    base_dir = os.getcwd()
    home_dir = os.path.join(base_dir, 'data8') 
    feature_dir = os.path.join(home_dir, 'data8_SOTA_and_handcrafts_and_BlookNet_optimal_entropy_features')
    result_dir = os.path.join(home_dir, 'training_data8_hieuvv_data8_SOTA_and_handcrafts_and_BlookNet_optimal_entropy_features_30_jan')
